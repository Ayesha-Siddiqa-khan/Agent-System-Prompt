...
| 2 | common-setup.sh | All EC2 instances | kubernetes-common |
| 3 | install-kubectl-cli.sh | All EC2 instances | kubectl-cli |
| 4 | control-plane-setup.sh | Kubernetes master / control plane only | kubernetes-control-plane |
| 5 | worker-join-setup.sh | Kubernetes worker nodes only | kubernetes-worker-join |
| 6 | install-helm.sh | Kubernetes master / control plane only | install-helm |
| 7 | install-nginx.sh | All EC2 instances | nginx |
